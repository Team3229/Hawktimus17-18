...
void Autonomous::SetupAutoCommands()
{
	...
	autocommand[left][leftswitch][M2].data = 13.0;
	...
	autocommand[left][leftscale][M5].data = 6;
	autocommand[left][leftscale][M6].command = push;
	autocommand[left][leftscale][M7].command = lower;
